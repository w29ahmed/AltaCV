...
\item Significantly reduced the effort needed to maintain code health through software architecture refactoring and setup of a continuous integration pipeline on a \textbf{Jenkins} build server that included unit tests with 90\% code coverage using \textbf{Google Test}
