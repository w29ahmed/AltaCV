...
\item Used \textbf{OpenCV} in \textbf{C++} to model and apply colour transformations 
...
\item Created a web interface using \textbf{JavaScript}, \textbf{HTML}, and \textbf{CSS} for convenient and intuitive usage of a colour manipulation algorithm 
\end{itemize}
\divider
