...
\item Created a web interface using \textbf{JavScript}, \textbf{HTML}, and \textbf{CSS} for convenient and intuitive usage of a colour manipulation algorithm 
\end{itemize}
\divider
...
\begin{itemize}
\item Leading software planning for a mobile racing robot set to compete in the \href{https://iarrc.org/}{\textbf{International Autonomous Robot Racing Competition}}
