...
\begin{itemize}
\item Programmed in \textbf{C++} to utilize a voltage divider circuit in order to read voltages up to 500 V with an error of \SI{\pm 1.4}{\percent}, displayed on a 16x2 LCD
\end{itemize}
...
\begin{itemize}
\item Utilized transfer learning on Google's Inception v3 image classifier to identify players on the Toronto Raptors using \textbf{TensorFlow}, an open source machine learning framework in \textbf{Python}
\end{itemize}
...
\begin{itemize}
\item Simple but efficient note taking app for Android API levels 15 and above constructed using \textbf{Java}, \textbf{XML}, and an \textbf{SQLite Database }
\end{itemize}
