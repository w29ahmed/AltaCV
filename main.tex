...
\item Restructured camera control modules in \textbf{C/C++} that use the \textbf{Camera Link} serial protocol to interface with the camera for control purposes
...
\cvevent{Software Team Lead \companylogo{pictures/UW_Robotics.png}{59mm}{http://uwrobotics.uwaterloo.ca/}}{UW Robotics}{Apr 2018 -- Present}{}
\begin{itemize}
\item Leading software team for a mobile racing robot set to compete in the \href{https://iarrc.org/}{\textbf{International Autonomous Robot Racing Competition}}
\item Developed software architecture using a \textbf{Linux} based framework; \textbf{ROS} (Robot Operating System), for efficient package management and communication between \textbf{computer vision} modules in \textbf{C++}
\item Used \textbf{CUDA}, NVIDIA's parallel computing platform for GPU optimization of \textbf{OpenCV} code in \textbf{C++} for lane and object detection
\end{itemize}
