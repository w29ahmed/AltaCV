...
\begin{itemize}
\item Built a backend processing pipeline in \textbf{Python} using \textbf{OpenCV} and \textbf{TensorFlow} capable of recognizing handwritten text from an agile board
